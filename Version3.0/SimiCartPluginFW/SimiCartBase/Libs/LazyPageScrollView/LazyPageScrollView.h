...
/*
 Cody changed this UIView to be Property for Outside Geters
 */
@property (strong, nonatomic) UIView *viewTopContent;

@property (nonatomic, strong) UIScrollView *viewScrollTop;
@property (nonatomic, strong) UIScrollView *viewScrollMain;
