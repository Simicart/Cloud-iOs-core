...
- (UIView *)createContainerView
{
    ...
    UIView *dialogContainer = [[UIView alloc] initWithFrame:CGRectMake((SCREEN_WIDTH - dialogSize.width) / 2, (SCREEN_HEIGHT - dialogSize.height) / 2, dialogSize.width, dialogSize.height)];
