...
#import "SimiTabViewController.h"
...
#pragma mark - SimiTabViewController
@interface SimiTabViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>
...
@implementation SimiTabViewController
...
- (void)setActiveContentIndex:(NSUInteger)activeContentIndex {
    ...
    __weak SimiTabViewController *weakSelf = self;
